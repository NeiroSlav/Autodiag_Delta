from structure.connections.switches.utils.mixin import SwitchMixin
from structure.connections.telnet import Telnet
...
class Raisecom(SwitchMixin):
    ...
    def mac(self, port: int) -> dict:
        ...
        for mac in self._finded:
            ...
            result['mac'][mac] = (mac == 'ТУТ БУДЕТ МАК АБОНА')
